...
<div className="flex items-center justify-center p-12">
  <WexSpinner className="h-8 w-8" />
</div>`})}),e.jsx(n,{title:"API Reference",children:e.jsx(a,{props:d})}),e.jsx(o,{tokens:c,className:"mt-12"})]})}export{y as default};
