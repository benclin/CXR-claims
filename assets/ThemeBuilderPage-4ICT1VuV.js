import{r as x,j as e,n as N,o as xe,p as G,c as F,P as q,q as ge,D as ne,s as fe,t as M,v as pe,T as be,w as D,W as J,C as ve,x as je,y as I,a as B,I as K,z as we,i as Y}from"./index-BphMwMYP.js";import{R as _,P as Z,N as ee,g as Ne,u as oe,T as ye,A as Ce,F as te,S as W,a as z,b as P,C as se,p as le,f as ce,c as ke}from"./tokenRegistry-DfqFgcHO.js";import{C as Se,g as Te,a as ie}from"./contrast-1QdVzTcJ.js";import{S as de,T as ue,a as Ee,R as Ve}from"./type-CnT9AOo3.js";import{C as Re}from"./credit-card-C_9NDuOY.js";import{S as me,M as he}from"./sun-x3cmQS-l.js";import{P as L}from"./prism-css-Za55PTRh.js";function $e(a,r){const m=ie.AA_NORMAL-r;return a.foreground.includes("foreground")?m>2?`Significantly low contrast (${r.toFixed(1)}:1). Try a much darker background shade or lighter text.`:m>1?"Moderate contrast issue. Try adjusting the background 2-3 shades darker.":"Nearly passing. Adjust the background 1 shade darker or lighter text.":`Current ratio is ${r.toFixed(2)}:1. WCAG AA requires 4.5:1 minimum.`}function Oe(){const[a,r]=x.useState([]),m=x.useCallback(()=>{const o=[];for(const l of Se){const p=Te(l.foreground,l.background);if(p){const w=p.rating!=="Fail";o.push({pair:l,ratio:p.ratio,rating:p.rating,passes:w,suggestion:w?void 0:$e(l,p.ratio)})}}r(o)},[]);x.useEffect(()=>{if(typeof window>"u")return;m();const o=new MutationObserver(()=>{requestAnimationFrame(m)});return o.observe(document.documentElement,{attributes:!0,attributeFilter:["style","class"]}),o.observe(document.body,{attributes:!0,attributeFilter:["class"]}),()=>{o.disconnect()}},[m]);const d=x.useMemo(()=>a.filter(o=>!o.passes).map(o=>({pair:o.pair,ratio:o.ratio,required:ie.AA_NORMAL,rating:o.rating})),[a]),t=a.filter(o=>o.passes).length,i=a.filter(o=>!o.passes).length,h=a.length,f=i===0&&h>0,n=x.useCallback(o=>a.some(l=>!l.passes&&l.pair.previewCard===o),[a]),g=x.useCallback(o=>a.filter(l=>l.pair.previewCard===o),[a]);return{results:a,issues:d,passCount:t,failCount:i,totalCount:h,isCompliant:f,hasIssuesForCard:n,getIssuesForCard:g}}const Ae=[{id:"button",label:"Button",icon:de,description:"Buttons with variants (primary, secondary, destructive)"},{id:"card",label:"Card",icon:Re,description:"Card containers with borders and backgrounds"},{id:"input",label:"Input",icon:ue,description:"Text input fields and form controls"},{id:"badge",label:"Badge",icon:Ee,description:"Status badges with intent colors"},{id:"alert",label:"Alert",icon:xe,description:"Alert messages with variants"}];function Ie({selectedComponent:a,onSelectComponent:r,className:m}){return e.jsxs("div",{className:N("space-y-2",m),children:[e.jsx("div",{className:"text-xs font-medium text-muted-foreground uppercase tracking-wider px-1 mb-2",children:"Components"}),e.jsx("div",{className:"grid grid-cols-1 gap-1.5",children:Ae.map(d=>{const t=d.icon,i=a===d.id;return e.jsxs("button",{type:"button",onClick:()=>r(d.id),className:N("flex items-center gap-3 px-3 py-2.5 rounded-md border transition-all text-left","hover:bg-muted/50 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-1",i?"border-primary bg-primary/5 ring-1 ring-primary/20":"border-border bg-background"),children:[e.jsx("div",{className:N("w-8 h-8 rounded-md flex items-center justify-center flex-shrink-0",i?"bg-primary/10 text-primary":"bg-muted text-muted-foreground"),children:e.jsx(t,{className:"w-4 h-4"})}),e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsx("div",{className:N("text-sm font-medium","text-foreground"),children:d.label}),e.jsx("div",{className:"text-xs text-muted-foreground truncate",children:d.description})]})]},d.id)})})]})}const Le=[{id:"color-ramps",label:"Color Ramps",icon:q,defaultOpen:!0},{id:"radius-presets",label:"Radius Presets",icon:de,defaultOpen:!0},{id:"typography",label:"Typography",icon:ue,defaultOpen:!1}];function Pe({selectedComponent:a,onSelectComponent:r,selectedFoundation:m,onSelectFoundation:d,onExport:t,onReset:i,hasUnsavedChanges:h=!1,hasOverrides:f=!1}){const{exitThemeBuilder:n,editMode:g,setEditMode:o}=G(),[l,p]=x.useState({"color-ramps":!0,"radius-presets":!0,typography:!1}),w=j=>{p(y=>({...y,[j]:!y[j]}))},C=x.useCallback(()=>{n()},[n]);return e.jsxs("div",{className:"h-full flex flex-col bg-muted/30 border-r border-border",children:[e.jsx("div",{className:"p-4 border-b border-border",children:e.jsx("div",{className:"text-sm font-semibold",children:"Theme Builder"})}),e.jsxs("div",{className:"p-3 border-b border-border",children:[e.jsx("div",{className:"text-[10px] font-medium text-muted-foreground uppercase tracking-wider mb-2",children:"Editing Mode"}),e.jsxs("div",{className:"flex gap-1 bg-muted rounded-lg p-1",children:[e.jsxs("button",{onClick:()=>o("light"),className:N("flex-1 flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-md text-sm transition-all",g==="light"?"bg-background shadow-sm text-foreground":"text-muted-foreground hover:text-foreground"),children:[e.jsx(me,{className:"h-3.5 w-3.5"}),"Light"]}),e.jsxs("button",{onClick:()=>o("dark"),className:N("flex-1 flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-md text-sm transition-all",g==="dark"?"bg-background shadow-sm text-foreground":"text-muted-foreground hover:text-foreground"),children:[e.jsx(he,{className:"h-3.5 w-3.5"}),"Dark"]})]})]}),e.jsxs("div",{className:"flex-1 overflow-y-auto",children:[e.jsx("div",{className:"p-3 border-b border-border",children:e.jsx(Ie,{selectedComponent:a,onSelectComponent:r})}),e.jsx(F,{}),e.jsxs("div",{className:"p-3",children:[e.jsx("div",{className:"text-xs font-medium text-muted-foreground uppercase tracking-wider mb-3",children:"Foundation"}),e.jsx("div",{className:"space-y-1",children:Le.map(j=>{const y=j.icon,E=m===j.id,s=l[j.id]??j.defaultOpen??!1;return e.jsx("div",{children:e.jsxs("button",{type:"button",onClick:()=>{w(j.id),d(j.id)},className:N("w-full flex items-center gap-2 px-2 py-1.5 rounded-md text-sm transition-all","hover:bg-muted/50 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-1",E&&"bg-primary/5 text-foreground"),children:[e.jsx(ge,{className:N("h-3.5 w-3.5 transition-transform text-muted-foreground",s&&"rotate-90")}),e.jsx(y,{className:"h-4 w-4 text-muted-foreground"}),e.jsx("span",{className:N("flex-1 text-left",E?"font-medium":"font-normal"),children:j.label})]})},j.id)})})]})]}),e.jsxs("div",{className:"p-3 border-t border-border space-y-1",children:[e.jsx(De,{}),e.jsx(F,{className:"my-2"}),e.jsx(X,{onClick:i,icon:e.jsx(Ve,{className:"h-4 w-4"}),label:"Reset All",disabled:!f}),e.jsx(X,{onClick:t,icon:e.jsx(ne,{className:"h-4 w-4"}),label:"Export Theme"}),e.jsx(F,{className:"my-2"}),e.jsx(X,{onClick:C,icon:e.jsx(fe,{className:"h-4 w-4"}),label:"Exit Theme Builder",badge:h?"●":void 0})]})]})}function De(){const{results:a,passCount:r,failCount:m,totalCount:d,isCompliant:t}=Oe(),{editMode:i}=G();if(d===0)return null;const h=i==="light"?me:he;return e.jsxs(M,{children:[e.jsx(M.Trigger,{asChild:!0,children:e.jsxs("button",{className:N("w-full flex items-center gap-2 px-3 py-2 rounded-md text-sm transition-colors",t?"text-success hover:bg-success/10":"text-destructive hover:bg-destructive/10"),children:[e.jsx(h,{className:"h-3.5 w-3.5 text-muted-foreground"}),t?e.jsx(pe,{className:"h-4 w-4"}):e.jsx(be,{className:"h-4 w-4"}),e.jsx("span",{className:"flex-1 text-left",children:t?"Contrast: OK":`Contrast: ${m} Issue${m!==1?"s":""}`}),e.jsxs("span",{className:"text-xs text-muted-foreground",children:[r,"/",d]})]})}),e.jsxs(M.Content,{side:"right",align:"end",className:"w-80 p-0 max-h-96 overflow-y-auto",children:[e.jsxs("div",{className:"p-3 border-b border-border sticky top-0 bg-popover",children:[e.jsxs("div",{className:"flex items-center gap-2 text-sm font-semibold",children:[e.jsx(h,{className:"h-4 w-4 text-muted-foreground"}),t?"All Contrast Checks Passing":"Contrast Issues Detected"]}),e.jsxs("div",{className:"text-xs text-muted-foreground mt-1",children:["WCAG AA requires 4.5:1 for normal text (",i," mode)"]})]}),e.jsx("div",{className:"p-3 space-y-2",children:a.map((f,n)=>e.jsxs("div",{className:N("p-2 rounded border text-xs",f.passes?"bg-success/5 border-success/20":"bg-destructive/5 border-destructive/20"),children:[e.jsxs("div",{className:"flex items-center justify-between mb-1",children:[e.jsx("span",{className:"font-medium",children:f.pair.name}),e.jsxs("span",{className:N("px-1.5 py-0.5 rounded text-[10px] font-medium",f.passes?"bg-success/20 text-success":"bg-destructive/20 text-destructive"),children:[f.ratio.toFixed(1),":1"]})]}),e.jsx("div",{className:"text-muted-foreground text-[10px]",children:f.pair.component}),!f.passes&&f.suggestion&&e.jsx("p",{className:"text-muted-foreground text-[10px] mt-1 pt-1 border-t border-border/50",children:f.suggestion})]},n))})]})]})}function X({onClick:a,icon:r,label:m,disabled:d,badge:t}){return e.jsxs("button",{onClick:a,disabled:d,className:N("w-full flex items-center gap-2 px-3 py-2 rounded-md text-sm transition-colors",d?"text-muted-foreground/50 cursor-not-allowed":"text-muted-foreground hover:text-foreground hover:bg-muted/50"),children:[r,e.jsx("span",{children:m}),t&&e.jsx("span",{className:"ml-auto text-warning text-xs",children:t})]})}const Ue=_.map(a=>({token:a.name,label:a.label.replace("Radius ",""),value:a.lightValue}));function Me({value:a,onChange:r,presets:m=Ue,label:d,className:t}){const[i,h]=x.useState({});x.useEffect(()=>{if(typeof window>"u")return;const n=()=>{const l={};m.forEach(p=>{const w=getComputedStyle(document.documentElement).getPropertyValue(p.token).trim();w?l[p.token]=w:l[p.token]=p.value}),h(l)};n();const g=new MutationObserver(()=>{n()});g.observe(document.documentElement,{attributes:!0,attributeFilter:["style","class"]});const o=setInterval(n,200);return()=>{g.disconnect(),clearInterval(o)}},[m]);const f=m.map(n=>({...n,value:i[n.token]||n.value}));return e.jsxs("div",{className:N("space-y-2",t),children:[d&&e.jsx("div",{className:"text-sm font-medium text-foreground",children:d}),e.jsx("div",{className:"flex gap-2",children:f.map(n=>{const g=a===n.token;return e.jsxs("button",{type:"button",onClick:()=>r(n.token),className:N("flex-1 flex items-center gap-3 px-3 py-2 rounded-md border transition-all","hover:bg-muted/50 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2",g?"border-primary bg-primary/5 ring-1 ring-primary/20":"border-border bg-background"),children:[e.jsx("div",{className:"w-16 h-12 rounded border border-border/50 flex items-center justify-center relative",style:{borderRadius:n.value,backgroundColor:"hsl(var(--wex-palette-slate-700))"},title:`Preview: ${n.value}`,children:e.jsx("span",{className:"text-xs text-white font-mono",children:n.value})}),e.jsx("span",{className:N("text-sm font-medium",g?"text-foreground font-semibold":"text-muted-foreground"),children:n.label})]},n.token)})})]})}function Fe(a){const r=a.match(/^(\w+)-(\d+)$/);return r?{name:r[1],shade:parseInt(r[2],10)}:null}function re({value:a,onSelect:r,children:m,className:d}){const[t,i]=x.useState(!1),h=Fe(a),f=x.useCallback((o,l)=>{r(`${o}-${l}`),i(!1)},[r]),n=x.useCallback(o=>{r(o),i(!1)},[r]),g=e.jsxs("div",{className:"space-y-3",children:[e.jsx("div",{className:"text-sm font-medium text-foreground",children:"Select Palette Shade"}),e.jsxs("div",{className:"space-y-1",children:[e.jsx("div",{className:"text-xs text-muted-foreground font-medium",children:"Neutrals"}),e.jsx("div",{className:"flex gap-1",children:ee.map(o=>{const l=a===o.name;return e.jsx("button",{type:"button",onClick:()=>n(o.name),title:o.label,className:N("w-6 h-6 rounded-sm transition-all border","hover:scale-110 hover:z-10 hover:ring-2 hover:ring-foreground/20","focus:outline-none focus:ring-2 focus:ring-primary",l&&"ring-2 ring-primary ring-offset-1",o.name==="white"&&"border-border"),style:{backgroundColor:`hsl(${o.value})`},children:e.jsx("span",{className:"sr-only",children:o.label})},o.name)})})]}),Z.map(o=>e.jsxs("div",{className:"space-y-1",children:[e.jsx("div",{className:"text-xs text-muted-foreground font-medium",children:o.label}),e.jsx("div",{className:"flex gap-1",children:o.shades.map(l=>{const p=h?.name===o.name&&h?.shade===l.shade;return e.jsx("button",{type:"button",onClick:()=>f(o.name,l.shade),title:`${o.label} ${l.shade}`,className:N("w-6 h-6 rounded-sm transition-all","hover:scale-110 hover:z-10 hover:ring-2 hover:ring-foreground/20","focus:outline-none focus:ring-2 focus:ring-primary",p&&"ring-2 ring-primary ring-offset-1"),style:{backgroundColor:`hsl(var(${l.token}))`},children:e.jsxs("span",{className:"sr-only",children:[o.label," ",l.shade]})},l.shade)})}),e.jsx("div",{className:"flex gap-1",children:o.shades.map(l=>e.jsx("div",{className:"w-6 text-center text-[8px] text-muted-foreground",children:l.shade},l.shade))})]},o.name))]});return m?e.jsxs(M,{open:t,onOpenChange:i,children:[e.jsx(M.Trigger,{asChild:!0,children:e.jsx("div",{className:d,children:m})}),e.jsx(M.Content,{className:"w-80 p-3",align:"start",sideOffset:8,children:g})]}):e.jsx("div",{className:"p-3",children:g})}function Be({value:a,size:r="md",className:m}){const d={sm:"w-4 h-4",md:"w-6 h-6",lg:"w-8 h-8"},[t,i]=x.useState(null),h=`--wex-palette-${a}`;x.useEffect(()=>{if(typeof window>"u")return;const n=()=>{const l=getComputedStyle(document.documentElement).getPropertyValue(h).trim();i(l||null)};n();const g=new MutationObserver(()=>{n()});g.observe(document.documentElement,{attributes:!0,attributeFilter:["style","class"]});const o=setInterval(n,200);return()=>{g.disconnect(),clearInterval(o)}},[h,a]);const f=t?`hsl(${t})`:`hsl(var(${h}))`;return e.jsx(D.Provider,{children:e.jsxs(D,{children:[e.jsx(D.Trigger,{asChild:!0,children:e.jsx("div",{className:N(d[r],"rounded-full border-2 border-border flex-shrink-0 cursor-help",m),style:{backgroundColor:f,minWidth:r==="sm"?"16px":r==="md"?"24px":"32px",minHeight:r==="sm"?"16px":r==="md"?"24px":"32px"}})}),e.jsx(D.Content,{children:e.jsx("p",{className:"text-xs font-mono",children:a})})]})})}function We({tokenName:a,size:r="md"}){const[m,d]=x.useState(null),t={sm:"w-4 h-4",md:"w-6 h-6",lg:"w-8 h-8"};x.useEffect(()=>{if(typeof window>"u")return;const h=()=>{const g=getComputedStyle(document.documentElement).getPropertyValue(a).trim();d(g||null)};h();const f=new MutationObserver(()=>{h()});f.observe(document.documentElement,{attributes:!0,attributeFilter:["style","class"]});const n=setInterval(h,200);return()=>{f.disconnect(),clearInterval(n)}},[a]);const i=m?`hsl(${m})`:`hsl(var(${a}))`;return e.jsx(D.Provider,{children:e.jsxs(D,{children:[e.jsx(D.Trigger,{asChild:!0,children:e.jsx("div",{className:N(t[r],"rounded-full border-2 border-border flex-shrink-0 cursor-help"),style:{backgroundColor:i,minWidth:r==="sm"?"16px":r==="md"?"24px":"32px",minHeight:r==="sm"?"16px":r==="md"?"24px":"32px"}})}),e.jsx(D.Content,{children:e.jsx("p",{className:"text-xs font-mono",children:a})})]})})}function He(a){return{button:"button",card:"card",input:"input",badge:"badge",alert:"alert"}[a]}function Q(a){const r=a.match(/^--wex-component-\w+-(primary|secondary|destructive|success|info|warning|default|neutral|outline|ghost|link)-/);return r&&r[1]?r[1]==="neutral"?"default":r[1]:null}function Ge(a){const r=new Map;return a.forEach(m=>{const d=Q(m.name);r.has(d)||r.set(d,[]),r.get(d).push(m)}),r}function ae(a,r,m){if(a.type==="size"&&a.name.includes("radius")){if(r[a.name]){const t=r[a.name].trim(),i=t.match(/var\((--wex-radius-\w+)\)/);return i&&i[1]?i[1]:(t.startsWith("--wex-radius-"),t)}if(a.references){const t=m==="light"?a.references:a.darkReferences||a.references;if(t&&t.startsWith("--wex-radius-"))return t}const d=m==="light"?a.lightValue:a.darkValue||a.lightValue;if(d&&d.trim().startsWith("var(")){const t=d.trim().match(/var\((--wex-radius-\w+)\)/);if(t&&t[1])return t[1]}return d}if(r[a.name]){const d=r[a.name].trim(),t=d.match(/var\(--wex-palette-(\w+)-(\d+)\)/);if(t)return`${t[1]}-${t[2]}`;const i=d.match(/var\(--wex-palette-(white|black)\)/);return i?i[1]:(/^\w+-\d+$/.test(d)||d==="white"||d==="black",d)}if(a.references){const d=m==="light"?a.references:a.darkReferences||a.references;if(d){const t=d.match(/--wex-palette-(\w+)-(\d+)/);if(t)return`${t[1]}-${t[2]}`;const i=d.match(/--wex-palette-(white|black)/);if(i)return i[1]}}return a.lightValue}function _e({component:a,overrides:r,onTokenChange:m,onVariantChange:d,className:t}){const[i,h]=x.useState(null),{editMode:f}=G();x.useEffect(()=>{d?.(i)},[i,d]);const n=He(a),o=Ne(n).filter(c=>{const v=c.type==="color"||c.type==="size"&&c.name.includes("radius"),b=c.name.includes("focus-ring");return v&&!b}),l=Ge(o),p=Array.from(l.keys()).filter(c=>c!==null);x.useEffect(()=>{p.length>0&&i===null&&h(p[0])},[p.length,i]);const w=x.useMemo(()=>{if(p.length===0)return o;if(i===null)return[];const c=(l.get(i)||[]).filter(b=>Q(b.name)===i),v=o.filter(b=>Q(b.name)===null);return[...c,...v]},[o,i,p.length,l]),C=w.filter(c=>c.type==="color"),j=w.filter(c=>c.type==="size"&&c.name.includes("radius")),y=x.useMemo(()=>{const c=v=>{const b=v.toLowerCase();return b.includes("title")&&(b.includes("fg")||b.includes("text"))||b.includes("header")&&(b.includes("fg")||b.includes("text"))?1:(b.includes("fg")||b.includes("text"))&&!b.includes("title")&&!b.includes("header")?2:b.includes("bg")?3:b.includes("border")?4:5};return[...C].sort((v,b)=>{const T=c(v.name),k=c(b.name);return T!==k?T-k:v.label.localeCompare(b.label)})},[C]),E={button:"Button",card:"Card",input:"Input",badge:"Badge",alert:"Alert"},s=x.useCallback((c,v)=>{m(c,`var(${v})`)},[m]),u=x.useCallback((c,v)=>{const b=`--wex-palette-${v}`;m(c,`var(${b})`)},[m]);return e.jsxs("div",{className:N("space-y-6",t),children:[e.jsxs("div",{children:[e.jsx("h2",{className:"text-lg font-semibold",children:E[a]}),e.jsx("p",{className:"text-sm text-muted-foreground",children:"Edit component-specific tokens. Changes apply to all instances of this component."})]}),p.length>0&&e.jsxs("div",{className:"space-y-2",children:[e.jsx("div",{className:"text-sm font-medium text-foreground",children:"Variant"}),e.jsx("div",{className:"flex gap-2 flex-wrap",children:p.map(c=>{const v=c.charAt(0).toUpperCase()+c.slice(1);return e.jsx("button",{type:"button",onClick:()=>h(c),className:N("px-3 py-1.5 rounded-md text-sm font-medium transition-all","border focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2",i===c?"border-primary bg-primary/5 text-foreground":"border-border bg-background text-muted-foreground hover:text-foreground hover:bg-muted/50"),children:v},c)})})]}),e.jsx(F,{}),y.length>0&&e.jsxs("div",{className:"space-y-4",children:[e.jsx("div",{className:"text-sm font-medium text-foreground",children:"Colors"}),e.jsx("div",{className:"space-y-3",children:y.map(c=>{const v=ae(c,r,f),b=/^\w+-\d+$/.test(v)||v==="white"||v==="black";return e.jsxs("div",{className:"flex items-center justify-between gap-4 p-3 rounded-md border border-border bg-card",children:[e.jsxs("div",{className:"flex-1 min-w-0",children:[e.jsx("div",{className:"text-sm font-medium",children:c.label}),c.description&&e.jsx("div",{className:"text-xs text-muted-foreground mt-0.5",children:c.description})]}),e.jsx("div",{className:"flex items-center gap-2",children:b?e.jsxs(e.Fragment,{children:[e.jsx(Be,{value:v,size:"sm"}),e.jsx(re,{value:v,onSelect:T=>u(c.name,T),children:e.jsx("button",{type:"button",className:"p-1.5 rounded-md border border-border bg-background hover:bg-muted/50 transition-colors",title:"Change color",children:e.jsx(q,{className:"h-4 w-4"})})})]}):e.jsxs(e.Fragment,{children:[e.jsx(We,{tokenName:c.name,size:"sm"}),e.jsx(re,{value:"blue-500",onSelect:T=>u(c.name,T),children:e.jsx("button",{type:"button",className:"p-1.5 rounded-md border border-border bg-background hover:bg-muted/50 transition-colors",title:"Change to palette color",children:e.jsx(q,{className:"h-4 w-4"})})})]})})]},c.name)})})]}),j.length>0&&e.jsx("div",{className:"space-y-4",children:j.map(c=>{const v=ae(c,r,f);return e.jsxs("div",{className:"space-y-2",children:[e.jsx("div",{className:"text-sm font-medium text-foreground",children:c.label}),c.description&&e.jsx("div",{className:"text-xs text-muted-foreground",children:c.description}),e.jsx(Me,{value:v,onChange:b=>s(c.name,b)})]},c.name)})}),w.length===0&&e.jsx("div",{className:"text-center py-8 text-muted-foreground",children:e.jsx("p",{className:"text-sm",children:"No editable tokens found for this component."})})]})}function Ke(a){const r=a.match(/^(\d+(?:\.\d+)?)/);return r?parseFloat(r[1]):0}function Ye({values:a,onChange:r,className:m}){const d=x.useCallback((t,i)=>{const h=Math.max(0,i);r(t,`${h}px`)},[r]);return e.jsxs("div",{className:N("space-y-4",m),children:[e.jsxs("div",{children:[e.jsx("h3",{className:"text-sm font-semibold text-foreground",children:"Radius Presets"}),e.jsx("p",{className:"text-xs text-muted-foreground mt-1",children:"Edit the base radius values. These cascade to all components that reference them."})]}),e.jsx(F,{}),e.jsx("div",{className:"space-y-4",children:_.map(t=>{const i=a[t.name]||t.lightValue,h=Ke(i);return e.jsxs("div",{className:"space-y-2",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{children:[e.jsx("div",{className:"text-sm font-medium",children:t.label}),t.description&&e.jsx("div",{className:"text-xs text-muted-foreground mt-0.5",children:t.description})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("input",{type:"number",min:"0",step:"1",value:h,onChange:f=>{const n=parseFloat(f.target.value)||0;d(t.name,n)},className:N("w-20 px-2 py-1.5 rounded-md border border-border bg-background","text-sm font-mono text-right","focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2")}),e.jsx("span",{className:"text-sm text-muted-foreground",children:"px"})]})]}),e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx("div",{className:"w-16 h-16 rounded border-2 border-border bg-muted/50 flex items-center justify-center",style:{borderRadius:i},children:e.jsx("div",{className:"text-xs text-muted-foreground",children:"Preview"})}),e.jsx("div",{className:"text-xs text-muted-foreground",children:e.jsx("code",{className:"font-mono",children:i})})]})]},t.name)})})]})}const H={50:97,100:93,200:85,300:72,400:56,500:45,600:38,700:32,800:26,900:20};function Xe(a){const r=(s,u,c)=>a[c][s]||u,m=(s,u,c,v)=>{const b={},T=`--wex-palette-${s}-500`,k=a[v][T];let $=u,A=c,U=H[500];if(k){const O=le(k);O&&($=O.h,A=O.s,U=O.l)}return[50,100,200,300,400,500,600,700,800,900].forEach(O=>{const S=`--wex-palette-${s}-${O}`;if(a[v][S])b[S]=a[v][S];else{const R=O===500?U:H[O];b[S]=ce({h:$,s:A,l:R})}}),b},d=s=>m("purple",270,60,s);let t=`/* ============================================================
...
`,ye.forEach(s=>{const u=r(s.name,s.lightValue,"light");t+=`  ${s.name}: ${u};
`}),t+=`
`,t+=`  /* ===== ACCESSIBILITY (3 tokens) ===== */
`,Ce.forEach(s=>{const u=r(s.name,s.lightValue,"light");t+=`  ${s.name}: ${u};
...
`,z.forEach(s=>{const u=r(s.name,s.lightValue,"light");t+=`  ${s.name}: ${u};
`}),t+=`
...
`;const f=P.filter(s=>s.name.includes("link"));f.forEach(s=>{const u=r(s.name,s.lightValue,"light");t+=`  ${s.name}: ${u};
`}),t+=`
...
`;const g=te.find(s=>s.name==="--wex-focus-ring-color");if(g){const s=r(g.name,g.lightValue,"light");t+=`  ${g.name}: ${s};
`}t+=`
...
`,z.forEach(s=>{const u=s.darkValue||s.lightValue,c=r(s.name,u,"dark");t+=`  ${s.name}: ${c};
`}),t+=`
...
`,f.forEach(s=>{const u=s.darkValue||s.lightValue,c=r(s.name,u,"dark");t+=`  ${s.name}: ${c};
`}),t+=`
`,t+=`  /* ===== INPUT (dark override) ===== */
`,n){const s=n.darkValue||n.lightValue,u=r(n.name,s,"dark");t+=`  ${n.name}: ${u};
`}if(t+=`
`,t+=`  /* ===== FOCUS RING (dark override) ===== */
`,g){const s=g.darkValue||g.lightValue,u=r(g.name,s,"dark");t+=`  ${g.name}: ${u};
`}t+=`
...
`}function Je(a){const r=new Set;if(Object.keys(a.light).forEach(i=>{i.startsWith("--wex-component-")&&r.add(i)}),Object.keys(a.dark).forEach(i=>{i.startsWith("--wex-component-")&&r.add(i)}),r.size===0)return`/* ============================================================
   ...
   ============================================================ */
`;const m=new Map;r.forEach(i=>{const h=i.match(/^--wex-component-(\w+)-/);if(h){const f=h[1];m.has(f)||m.set(f,[]);const n=a.light[i]||a.dark[i]||"";m.get(f).push({token:i,value:n})}});let d=`/* ============================================================
...
`,i.forEach(({token:f,value:n})=>{d+=`  ${f}: ${n};
`}),d+=`
`}),d+=`}
...
`,d}function ze(a){const r={wex:{}},m=(h,f,n)=>a[n][h]||f,d=(h,f,n,g)=>{const o={},l=`--wex-palette-${h}-500`,p=a[g][l];let w=f,C=n,j=H[500];if(p){const y=le(p);y&&(w=y.h,C=y.s,j=y.l)}return[50,100,200,300,400,500,600,700,800,900].forEach(y=>{const E=`--wex-palette-${h}-${y}`;if(a[g][E])o[E]=a[g][E];else{const s=y===500?j:H[y];o[E]=ce({h:w,s:C,l:s})}}),o},t=(h,f,n)=>{const g=f.split(".");let o=h;for(let l=0;l<g.length-1;l++){const p=g[l];(!(p in o)||typeof o[p]!="object"||o[p]===null)&&(o[p]={}),o=o[p]}o[g[g.length-1]]=n},i=(h,f="")=>{Z.forEach(n=>{const g=d(n.name,n.hue,n.saturation,h);Object.entries(g).forEach(([o,l])=>{const p=o.replace("--wex-","").replace(/-/g,".");t(r.wex,p+f,{value:l,type:"color"})})}),ee.forEach(n=>{const g=m(n.token,n.value,h),o=n.token.replace("--wex-","").replace(/-/g,".");t(r.wex,o+f,{value:g,type:"color"})}),P.forEach(n=>{const g=h==="dark"&&n.darkValue||n.lightValue,o=m(n.name,g,h),l=n.name.replace("--wex-","").replace(/-/g,".");t(r.wex,l+f,{value:o,type:"color"})}),W.forEach(n=>{const g=h==="dark"&&n.darkValue||n.lightValue,o=m(n.name,g,h),l=n.name.replace("--wex-","").replace(/-/g,".");t(r.wex,l+f,{value:o,type:"color"})}),z.forEach(n=>{const g=h==="dark"&&n.darkValue||n.lightValue,o=m(n.name,g,h),l=n.name.replace("--wex-","").replace(/-/g,".");t(r.wex,l+f,{value:o,type:"color"})}),ke.forEach(n=>{if(n.type==="color"){const g=h==="dark"&&n.darkValue||n.lightValue,o=m(n.name,g,h),l=n.name.replace("--wex-","").replace(/-/g,".");t(r.wex,l+f,{value:o,type:"color"})}})};return i("light"),i("dark",".dark"),JSON.stringify(r,null,2)}function Qe(a){const{getAllOverrides:r}=oe(),m=r(),[d,t]=x.useState(!1),[i,h]=x.useState(!1),[f,n]=x.useState(!1),[g,o]=x.useState(!1),[l,p]=x.useState("tokens"),w=x.useMemo(()=>Xe(m),[m]),C=x.useMemo(()=>qe(),[]),j=x.useMemo(()=>Je(m),[m]),y=x.useMemo(()=>ze(m),[m]),E=x.useMemo(()=>{try{return L.highlight(w,L.languages.css,"css")}catch{return w}},[w]),s=x.useMemo(()=>{try{return L.highlight(C,L.languages.css,"css")}catch{return C}},[C]),u=x.useMemo(()=>{try{return L.highlight(j,L.languages.css,"css")}catch{return j}},[j]),c=x.useMemo(()=>{try{return L.highlight(y,L.languages.json,"json")}catch{return y}},[y]),v=x.useCallback(async()=>{try{await navigator.clipboard.writeText(w),t(!0),setTimeout(()=>t(!1),2e3)}catch(S){console.error("Failed to copy CSS:",S)}},[w]),b=x.useCallback(async()=>{try{await navigator.clipboard.writeText(C),h(!0),setTimeout(()=>h(!1),2e3)}catch(S){console.error("Failed to copy shadcn bridge:",S)}},[C]),T=x.useCallback(async()=>{try{await navigator.clipboard.writeText(j),n(!0),setTimeout(()=>n(!1),2e3)}catch(S){console.error("Failed to copy components bridge:",S)}},[j]),k=x.useCallback(async()=>{try{await navigator.clipboard.writeText(y),o(!0),setTimeout(()=>o(!1),2e3)}catch(S){console.error("Failed to copy JSON:",S)}},[y]),$=x.useCallback(()=>{const S=new Blob([w],{type:"text/css"}),R=URL.createObjectURL(S),V=document.createElement("a");V.href=R,V.download="tokens.css",V.click(),URL.revokeObjectURL(R)},[w]),A=x.useCallback(()=>{const S=new Blob([C],{type:"text/css"}),R=URL.createObjectURL(S),V=document.createElement("a");V.href=R,V.download="shadcn-bridge.css",V.click(),URL.revokeObjectURL(R)},[C]),U=x.useCallback(()=>{const S=new Blob([j],{type:"text/css"}),R=URL.createObjectURL(S),V=document.createElement("a");V.href=R,V.download="components-bridge.css",V.click(),URL.revokeObjectURL(R)},[j]),O=x.useCallback(()=>{const S=new Blob([y],{type:"application/json"}),R=URL.createObjectURL(S),V=document.createElement("a");V.href=R,V.download="wex-tokens.json",V.click(),URL.revokeObjectURL(R)},[y]);return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`
